...
export class Convert {
  public static toRESTContriesRespond(json: string): pais[] {
      return cast(JSON.parse(json), a(r("RESTContriesRespond")));
  }

  public static rESTContriesRespondToJson(value: pais[]): string {
      return JSON.stringify(uncast(value, a(r("RESTContriesRespond"))), null, 2);
  }
}
